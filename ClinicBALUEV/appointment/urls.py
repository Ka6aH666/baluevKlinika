...
ajax_urlpatterns = [
    ...
    path('fetch_service_duration/', views.fetch_service_duration, name="fetch_service_duration"),
...
admin_urlpatterns = [
    ...
    path(
        "edit_calendar_settings/<staff_member_user_id>",
        views_admin.edit_calendar_settings,
        name="edit_calendar_settings",
    ),
    path("add_specialization/",
         views_admin.add_specialization, name="add_specialization",
         ), path(
        "add_specialization/<spec_id>", views_admin.add_specialization,
        name="add_specialization", ),
    path("get_specialization_list/",
         views_admin.get_specialization_list, name="get_specialization_list",
    ),
]
